...
define('text!templates/example.html',[],function () { return '<div id="map_canvas"></div>\ninside the template\n';});
...
function(namespace, $, Backbone, tmpl) {
  ...
  Example.Views.Tutorial = Backbone.View.extend({
    ...
    render: function() {
      ...
      var map = new google.maps.Map($(this.el).find('#map_canvas').first(),
          myOptions);
console.log(map);
